    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title"><i class="f   a-solid fa-square-poll-vertical"></i> Coaching</h5>
              <button type="button" class="btn bi bi-plus btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#pelatihanModal"> Add Coaching</button>
              <br><br>
              <!-- Modal Add -->
                ...
                <div class="modal-dialog modal-lg">
                    ...
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">Add Coaching</h1>
                    ...
                    <div class="modal-body">
                         <form class="row g-3">
                            ...
                            <div class="form-floating">
                                ...
                                <label for="floatingSelect">Jenis Coaching</label>
                            </div>
                            </div>
                            <div class="col-md-12">
                            <div class="form-floating">
                                <textarea class="form-control" placeholder="Address" id="floatingTextarea" style="height: 100px;"></textarea>
                                <label for="floatingTextarea">Informasi Coaching :</label>
                            </div>
                            </div>
                            <div class="col-md-12">
                            <div class="form-floating">
                                <textarea class="form-control" placeholder="Address" id="floatingTextarea" style="height: 100px;"></textarea>
                                <label for="floatingTextarea">Deskripsi Coaching :</label>
                            </div>
                            </div>
                            <div class="col-md-4">
                            <div class="form-floating">
