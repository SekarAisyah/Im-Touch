              ...
              <!-- Modal Add -->
                ...
                <div class="modal-dialog modal-lg">
                    ...
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">Add Pelatihan</h1>
                    ...
                    <div class="modal-body">
                         <form class="row g-3">
                            ...
                            <div class="form-floating">
                                ...
                                <label for="floatingSelect">Jenis Pelatihan</label>
                            </div>
                            </div>
                            <div class="col-md-12">
                            <div class="form-floating">
                                <textarea class="form-control" placeholder="Address" id="floatingTextarea" style="height: 100px;"></textarea>
                                <label for="floatingTextarea">Informasi Pelatihan :</label>
                            </div>
                            </div>
                            <div class="col-md-6">
                            <div class="form-floating">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="namaPelatihan" placeholder="Nama Pelatihan">
                                <label for="nama pelatihan">Narasumber</label>
                            </div>
                            </div>
                            ...
                            <div class="form-floating">
                                <textarea class="form-control" placeholder="Address" id="floatingTextarea" style="height: 100px;"></textarea>
                                <label for="floatingTextarea">Alasan Permohonan Pelatihan :</label>
                            </div>
                            </div>
                            <div class="col-md-12">
                            <div class="form-floating">
                                <textarea class="form-control" placeholder="Address" id="floatingTextarea" style="height: 100px;"></textarea>
                                <label for="floatingTextarea">Setelah Melakukan Pelatihan, Harus Sharing Kepada :</label>
                            </div>
                            </div>
                            <div class="col-md-4">
                            <div class="form-floating">
