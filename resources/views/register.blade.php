              ...
              <div class="">
                ...
                <div class="">
                  ...
                  <form class="row g-3 needs-validation" novalidate>
                    <img class = "form-login" src="assets/img/Innovkitaa.png" alt="">
                    <div class="col-10 form-input">
                      <input type="text" name="name" class="form-control" id="yourName" required placeholder="Your Name">
                      <div class="invalid-feedback">Please enter your name!</div>
                    </div>
                    <div class="col-10 form-input">
                      <div class="input-group has-validation">
                        <span class="input-group-text" id="inputGroupPrepend">@</span>
                        <input type="text" name="username" class="form-control" id="yourEmail" required placeholder=" Your Email">
...
{{-- 
                    ...
                    <div class="col-10 form-input">
                      <button class="btn btn-primary w-100 btn-sm form-a" type="submit"><a href="/login">Register</a></button> 
                    <div class="col-10 form-input">
                      <p class="small mb-0">Already have an account?<a href="/login"> Sign in</a></p>
                    </div>
                  </form>
