                                    ...
                                    <div class="modal-body">
                                        <div class="pelatihan-details">
                                            ...
                                            <div class="detail">
                                             ...
                                             <div class="detail">
                                                <label for="ket_HR">Keterangan Superintendent PD:</label>
                        ...
                        <div class="modal fade modal_send" id="sendModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form class="kt-form kt-form--label-right form_send" action="/pelatihan/send-data"  method="POST" enctype="multipart/form-data" autocomplete="off">
                                            @csrf
                                            <div class="form-group">
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    @if (auth()->user()->id_role == 0)
                                                        <ul class="dropdown-menu">
                                                            ...
                                                            <li><a class="dropdown-item send-link" href="#" data-bs-toggle="modal"
        ...
        $('.view').click(function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.APPRV_ATASAN == 0 && response.STATUS == 7 ) {
                        $app1 = '<span style="color: red;">Reject Pengajuan</span>';
                    } else if (response.APPRV_ATASAN == 0  ) {
                    ...
                    if (response.APPRV_HR == 0 && response.STATUS == 7) {
                        $app2 = '<span style="color: red;">Reject Pengajuan</span>';
                    } else if (response.APPRV_HR == 0  ) {
                    ...
                    $('#viewPelatihanModal').find('#approval_HR').html($app2);
                    if (response.APPRV_HR_MNG == 0 && response.STATUS == 7 ) {
                        $app3 = '<span style="color: red;">Reject Pengajuan</span>';
                    } else if (response.APPRV_HR_MNG == 0 ) {
                    ...
                    if (response.APPRV_DRC == 0 && response.STATUS == 7 ) {
                        $app1 = '<span style="color: red;">Reject Pengajuan</span>';
                    } else if (response.APPRV_DRC == 0) {
                        $app1 = '<span style="color: red;">Revisi Pengajuan</span>';
